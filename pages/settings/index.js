...
Page({
    ...
    onInputNickName(e) {
        ...
        wx.request({
            url: app.globalData.isDebuggingBackend ? 'http://localhost:3000/v1/user/nickname' : 'https://api.wechat.image-downloader.ibenzene.cn/v1/user/nickname',
            method: 'PUT',
            data: {
        ...
        wx.login({
            success: res => {
                if (res.code) {
                    ...
                    wx.request({
                        url: app.globalData.isDebuggingBackend ? 'http://localhost:3000/v1/user/login' : 'https://api.wechat.image-downloader.ibenzene.cn/v1/user/login',
                        method: 'POST',
                        data: {
                            code: res.code,
                            nickName: this.data.userInfo.nickName
